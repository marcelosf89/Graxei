...
using Graxei.Search.Mapping;
using Graxei.Search.Reader;
    ...
    public class SearchFactoryImpl : ISearchFactoryImplementor
    {
        ...
        private static Analyzer InitAnalyzer(Configuration cfg)
        {
           ...
           // Initialize analyzer
            ...
            try
            {
                defaultAnalyzer = (Analyzer) Activator.CreateInstance(analyzerClass,new object[] {Lucene.Net.Util.Version.LUCENE_30});
            }
