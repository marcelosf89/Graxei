...
namespace Graxei.Search.Tests.FieldAccess
{
    [TestFixture]
    public class FieldAccessTest : SearchTestCase
    {
        ...
        public void FieldBoost()
        {
            ...
            QueryParser p = new QueryParser(Lucene.Net.Util.Version.LUCENE_30, "id", new StandardAnalyzer(Lucene.Net.Util.Version.LUCENE_30));
