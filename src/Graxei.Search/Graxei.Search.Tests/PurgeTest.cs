namespace Graxei.Search.Tests
{
    ...
    public class PurgeTest : SearchTestCase
    {
        ...
        public void Purge()
        {
            ...
            QueryParser parser = new QueryParser(Lucene.Net.Util.Version.LUCENE_30, "Brand", new StopAnalyzer(Lucene.Net.Util.Version.LUCENE_30));
