namespace Graxei.Search.Tests.Bridge
{
    ...
    public class ClassBridgeTest : SearchTestCase
    {
        ...
        public void ClassBridge()
        {
            ...
            QueryParser parser = new QueryParser(Lucene.Net.Util.Version.LUCENE_30, "branchnetwork", new SimpleAnalyzer());
            ...
            parser = new QueryParser(Lucene.Net.Util.Version.LUCENE_30, "BranchHead", new SimpleAnalyzer());
        ...
        public void ClassBridges()
        {
            ...
            QueryParser parser = new QueryParser(Lucene.Net.Util.Version.LUCENE_30, "equipment", new SimpleAnalyzer());
            ...
            parser = new QueryParser(Lucene.Net.Util.Version.LUCENE_30, "branchnetwork", new SimpleAnalyzer());
        ...
        protected override void Configure(Configuration configuration)
        {
            ...
            configuration.SetProperty(
                    Graxei.Search.Environment.AnalyzerClass, typeof(SimpleAnalyzer).AssemblyQualifiedName);
        }
