...
namespace Graxei.Search.Tests.Inheritance
{
    ...
    public class ProxyObjectInheritanceTest : SearchTestCase
    {
        ...
        public void ProxyObjectInheritance()
        {
            ...
            string classTypeThatWasIndex = Document.Get(Graxei.Search.Engine.DocumentBuilder.CLASS_FIELDNAME);

            // get the expected lucene type name (this should be equivilent to 
            // the static method of Graxei.Search.Util.TypeHelper.LuceneTypeName
