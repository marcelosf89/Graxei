using System.Xml;
using Graxei.Search.Cfg;
using NUnit.Framework;

namespace Graxei.Search.Tests.Cfg
{
	[TestFixture]
	public class ConfigurationFixture
	{
		...
		public void WellFormedConfiguration()
		{
			string xml =
				@"<nhs-configuration xmlns='urn:nhs-configuration-1.0'>
                      <search-factory>
                        <property name='hibernate.search.default.directory_provider'>Graxei.Search.Storage.FSDirectoryProvider, Graxei.Search</property>
			...
			Assert.AreEqual("Graxei.Search.Storage.FSDirectoryProvider, Graxei.Search",
