namespace Graxei.Search.Tests.Embedded
{
    ...
    public class IndexedEmbeddedAndCollections : SearchTestCase
    {
        ...
        public void CanLookupEntityByValueOfEmbeddedSetValues()
        {
            ...
            QueryParser parser = new MultiFieldQueryParser(Lucene.Net.Util.Version.LUCENE_30, new string[] { "name", "authors.name" }, new StandardAnalyzer(Lucene.Net.Util.Version.LUCENE_30));
