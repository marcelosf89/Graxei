...
{
    public class LinkBuilderPadraoStrategy : ILinkBuilderStrategy
    {
        public LinkBuilderPadraoStrategy(AjaxHelper ajaxHelper, string controller, string action, PaginaAtualLista paginaAtualLista)
        {
