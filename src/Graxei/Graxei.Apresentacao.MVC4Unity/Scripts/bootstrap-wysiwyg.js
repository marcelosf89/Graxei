!function($, wysi) {
    ...
    var tpl = {
        ...
        "color": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
				...
				"<div class='wysihtml5-colors-min' data-wysihtml5-command-value='black'></div>" +
                "<span class='current-color'>" + 
				locale.colours.black + "</span>&nbsp;<b class='caret'></b>" +
                "</a>" +
                "<ul class='dropdown-menu'>" +
    ...
    Wysihtml5.prototype = {
        ...
        createToolbar: function(el, options) {
            ...
            toolbar.find("a[data-wysihtml5-command='foreColor']").click(function(e) {
				...
				self.toolbar.find('.wysihtml5-colors-min').attr('data-wysihtml5-command-value',el.attr('data-wysihtml5-command-value'));
            });
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: [".Content/bootstrap3-wysiwyg5-color/bootstrap3-wysiwyg5-color.css"], // (path_to_project/lib/css/bootstrap3-wysiwyg5-color.css)
        locale: "en"
    };
