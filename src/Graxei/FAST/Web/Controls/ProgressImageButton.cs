...
{
    /// <summary>
    /// Classe para WebControl de ImageButton com indicador de progresso
    /// </summary>
    [ToolboxData("<{0}:ProgressImageButton runat=server></{0}:ProgressImageButton>")]
    public class ProgressImageButton : ImageButton
    {
        #region Fields
